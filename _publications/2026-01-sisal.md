...
<table>
  <tr>
    <td align="center" colspan="2" style="padding: 15px;">
      ...
      <img src="{{ site.url }}/images/SiSAL/synthetic_dataset.png" width="400"><br>
    </td>
  </tr>
  <tr>
    <td align="center" style="padding: 15px;">
      <em><strong>(b)</strong> Latent representation colored by tissue structure membership.</em>
      <img src="{{ site.url }}/images/SiSAL/synthetic_latent.png" width="300"><br>
    </td>
    <td align="center" style="padding: 15px;">
      <em><strong>(c)</strong>Latent representation colored by \(SNR = \frac{test1}{test2}\)</em>
      <img src="{{ site.url }}/images/SiSAL/synthetic_SNR_latent.png" width="300"><br>
    </td>
  </tr>
</table>
